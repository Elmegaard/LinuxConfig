        ...
        (function () {
            ...
            //  ======
                var _encode = function (_string)
                {
                    ...
                    //  use encodeURIComponent on _string
                };
        ...
        //  =========
            ...
            (function ($C) {
                ...
                chrome.extension.sendMessage({ '_type': "to-chrome--load-info" }, function(response)
                {
                    ...
                    //  inject
                    $C.inject_script_and_definitions(document, 'chrome-extension://iooicodkiihhpojmmeghjclgihfjdjhj/front/in_reminder/script.js', $C.loaded_info.as_html);
                });
